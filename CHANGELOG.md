...
- **FULL RESTORE FROM JSON in PROTOCOL's DATA PORT.** Picks a backup file and replaces your entire current configuration with it -- every deck, DSP setting, root override, quick action, emergency prompt, target computer entry, voice recording, and autocomplete history -- rather than IMPORT .JSON's narrower "matrix phrases into a new deck" behavior. Requires confirming first; this cannot be undone.
